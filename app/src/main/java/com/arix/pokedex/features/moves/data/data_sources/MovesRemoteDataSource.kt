...
class MovesRemoteDataSource(
    ...
    suspend fun getMoveList(
        ...
        return if (searchQuery.isBlank())
            makeHttpRequest { pokeListsApiService.getMoveList(limit, offset, limitedList) }
        else makeHttpRequest { pokeListsApiService.getMoveList(searchQuery, limit, offset, limitedList) }
    }
